...
from totp import generate_totp_secret  # Import relatif depuis le dossier parent
...
class MainWindow(toga.MainWindow):
    def __init__(self, title, app):
        ...
        # Bouton de copie
        self.copy_button = toga.Button(icon=toga.Icon(CLIPBOARD), style=Pack(width=30,flex=1), on_press=self.copy_to_clipboard)
